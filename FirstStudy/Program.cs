namespace FirstStudy
{
    ...
    class 영희
    {
        ...
        //private - 이 클래스말고 다른 클래스는 해당 멤버에 접근하 수 없다.
        ...
        //->접근제한자를 명시하지않은면 외부 접근을 차단하는게 (private) 기본컨셉
    ...
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            string somethingToPring = "영희의 나이는" + 영희1.나이.ToString() + "살 입니다";
            Console.WriteLine(somethingToPring);
